...
if (isset($data["add-to-cart"])){
    ...
    $updateQuantity = mysqli_query($con, "UPDATE jeuvideo SET quantite = '$productQuantity' - 1 WHERE nom = '$productName'");
}
?>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav menu-right me-auto mb-2 mb-lg-0">
        <li >
            <div class="cart">
                <a class="nav-link" href="http://localhost/Projet/login1.php"><i class="bx bx-cart"></i></a>
            </div>
        </li>
        <li>
            <div class="login">
        ...
        <?php
            ...
            if (mysqli_num_rows($queryProduct) > 0){
                ...
                <div class="cont-elem">
                    ...
                    <a href="<?php echo $fetchProduct['gamessite']; ?>">
          ...
          <?php
            ...
            if (mysqli_num_rows($queryProduct) > 0){
                ...
                <div class="cont-elem">
                    <a href="<?php echo $fetchProduct['consolessite']; ?>">
                        <img src="resim/<?php echo $fetchProduct["img"] ; ?>" alt="" class="img-fluid hovered thumbnail">  
          ...
          <?php
            ...
            if (mysqli_num_rows($queryProduct) > 0){
                ...
                <div class="cont-elem">
                    <a href="<?php echo $fetchProduct['accessoiresite']; ?>">
                        <img src="resim/<?php echo $fetchProduct["img"] ; ?>" alt="" class="img-fluid hovered thumbnail">  
