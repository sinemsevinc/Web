  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav menu-right me-auto mb-2 mb-lg-0">
        ...
        <li>
            <a href="edituser.php" ><?php echo $username; ?></a>
...
<!-- Navbar -->
    ...
    <div class="container">
        ...
        <?php
        $selectProduct = "SELECT * FROM jeuvideo";
            ...
            if (mysqli_num_rows($queryProduct) > 0){
                ...
                <div class="cont-elem">
                    <form action="" method="post">
                        ...
                        <input type="hidden" name="id" value="<?php echo $fetchProduct["JeuID"]; ?>">
                    </form>
                    ...
                    <p class="nom"><?php echo $fetchProduct["nom"]; ?></p>
                        ...
                        <form action="" method="post">
                            ...
                            <?php if($fetchProduct["quantite"] >0) { ?>
