...
if (isset($data["add-to-cart"])){
  ...
  if($productQuantity >0)
    $updateQuantity = mysqli_query($con, "UPDATE accessoire SET quantite = '$productQuantity' - 1 WHERE nom = '$productName'");
}
...
<?php
        $selectProduct = "SELECT * FROM accessoire";
            ...
            if (mysqli_num_rows($queryProduct) > 0){
                ...
                <div class="cont-elem">
                    <form action="" method="post">
                        ...
                        <input type="hidden" name="id" value="<?php echo $fetchProduct["AccessoireID"]; ?>">
                    </form>
